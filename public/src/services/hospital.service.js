...
class HospitalService {
    constructor() {
        this.hospitalRepository = new repositories_1.HospitalRepository();
    }
    create(hospitalData) {
        var _a, _b;
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.hospitalRepository.create(hospitalData);
                return {
                    status: 'success',
                    content: response
                };
    ...
    update(hospitalData, id) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.hospitalRepository.update(hospitalData, id);
                return {
                    status: 'success',
                    content: response
                };
    ...
    delete(id) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                yield this.hospitalRepository.delete(id);
                return {
                    status: "success",
                    content: {
    ...
    get() {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.hospitalRepository.get();
                return {
                    status: 'success',
                    content: response
                };
    ...
    getbyId(id) {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const response = yield this.hospitalRepository.getbyId(id);
                if (response === null) {
                    let response = [];
                    return {
                        status: 'success',
